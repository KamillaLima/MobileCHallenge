...
import Insetos from '../assets/insetos.png';
...
const Controle = () => {
  ...
  async function Busca() {
    const resultado = await buscaAlgo('controle');
      ...
      <View
        ...
        <ScrollView>
          <View style={{ alignItems: 'center' }}>
            <Image source={Insetos} style={{ marginTop: 15 }} />
          </View>
          <View style={{ paddingHorizontal: 12 }}>
            <Text style={estilo.tituloComunidade}>Controle de pragas</Text>
